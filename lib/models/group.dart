  ...
  factory FantasyGroup.fromJson(Map<String, dynamic> json) {
    ...
    return FantasyGroup(
      ...
      createdBy: _stringValue(
        json['created_by'],
        fallback: _stringValue(json['createdBy']),
      ),
      createdAt: _dateTimeValue(json['created_at']) ??
          _dateTimeValue(json['createdAt']),
      inviteCode:
          storedInviteCode.isNotEmpty ? storedInviteCode : _fallbackInviteCode(id),
      memberCount: _intValue(
        json['member_count'],
        fallback: _intValue(json['memberCount']),
      ),
    );
  }
}
