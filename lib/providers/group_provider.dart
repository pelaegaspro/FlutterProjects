...
class SelectedGroupIdNotifier extends Notifier<String?> {
  ...
  void setSelectedGroupId(String? groupId) => state = groupId;
}
...
final currentGroupMessagesProvider =
    StreamProvider<List<GroupChatMessage>>((ref) {
...
final currentGroupLeaderboardProvider =
    StreamProvider<List<GroupLeaderboardEntry>>((ref) {
  final group = ref.watch(currentGroupProvider);
  if (group == null) {
